...
Prefer systems that can be understood under pressure.

Document the weird edge cases.

Use boring foundations where they matter.

Use hacky ideas where they unlock something useful.
...
Many repositories here are experiments, prototypes, or active workbenches. Some are polished. Some are intentionally messy while the idea is still being discovered.
...
Practical infrastructure, automation, and hardware-adjacent tools for real-world problems.
